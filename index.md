...
<style>
  ...
  .journal-card:nth-child(2) {
    background: linear-gradient(135deg, #8e5dad, #d06988);
  }

  .journal-card:nth-child(3) {
    background: linear-gradient(135deg, #df795d, #d7ab53);
  }

  .journal-card:nth-child(4) {
    background: linear-gradient(135deg, #4361a8, #7775c3);
  }

  .journal-card:nth-child(5) {
    background: linear-gradient(135deg, #177d78, #70a847);
  }

  .journal-card:nth-child(6) {
    background: linear-gradient(135deg, #b64e5c, #df8b79);
  }

  .journal-card:nth-child(7) {
    background: linear-gradient(135deg, #305d91, #3978ad);
  }

  .journal-card:nth-child(8) {
    background: linear-gradient(135deg, #6556a4, #b3639d);
  }

  .journal-card:nth-child(9) {
    background: linear-gradient(135deg, #39756c, #78a568);
  }

  .journal-card:nth-child(10) {
    background: linear-gradient(135deg, #a65562, #ce7969);
  }

  .journal-card:nth-child(11) {
    background: linear-gradient(135deg, #3d658b, #5599a5);
  }

  .journal-card:nth-child(12) {
    background: linear-gradient(135deg, #876249, #c69763);
  }

  .journal-card:nth-child(13) {
    background: linear-gradient(135deg, #585b97, #9675aa);
  }
...
<section class="journal-intro">
  ...
  <p>
    As a second-year student in IT Management and Design, I chose this course
    because I spent the entire semester last year studying Data Analytica.
    I initially thought this was a good thing, but now it seems it significantly
    limited my imagination. As a design student, I am interested in UI/UX,
